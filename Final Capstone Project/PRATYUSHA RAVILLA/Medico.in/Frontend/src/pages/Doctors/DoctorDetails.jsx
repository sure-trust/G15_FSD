     ...
     <div className="grid md:grid-cols-3 gap-[50px]">
      ...
      <div>
       ...
       <p className="text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
        Best Neurologist in our hospital.
       </p>
       ...
       <div className="mt-[50px] border-b border-solid border-[#0066ff34]">
        ...
        className={`${tab =='about'
        && 'border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold group hover:bg-primaryColor hover:border-none` } >
          About
          </button>
